...
(function ($) {
    ...
    $.Scalebar.prototype = {
        ...
        drawMicroscopyScalebar: function (size, text) {
            ...
            // console.log(this.divElt.style.width)
            this.divElt.style.width = "150px";
        },
    ...
    function getScalebarSizeAndTextForMetric(ppm, minSize, unitSuffix) {
        var value = normalize(ppm, minSize);
        // console.log(value, "----", minSize, "----", ppm);
        // console.log(value / ppm);
        var factor = roundSignificand((value / ppm) * minSize, 3);
        // console.log((value / ppm));
        var size = value * minSize;
    ...
    function roundSignificand(x, decimalPlaces) {
        ...
        // if (power < 0) {
        //     return significand * Math.pow(10, -power);
        // }
        // return significand / Math.pow(10, power);
        if (power < 0) {
